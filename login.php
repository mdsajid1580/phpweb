...
<body>
<div class="conatiner-fluid bg">

	<div class="row">
		<div class="com-md-4 col-sm-4 col=xl-12"></div>
		<div class="com-md-4 col-sm-4 col=xl-12">
		<form class="form-design">
			<h4>Login to Ramanasri Institute</h2>
		    ...
		    <br><br>
		    <p class="text-white"> New to website? <a href=""> <span class=" strong bg-primary text-white regis"> REGISTER </span></a></p>
		</form>	
